...
function Home() {
  ...
  <div className="home">
    ...
    <div className="home__milkshake">
      ...
      <h3>Hey.</h3>
      <h4>I'm Daniel(not Day)Lewis. <br />I do not drink your milkshake.</h4>
      <p>(click the milkshake if you need a reference)</p>
      <a className="home__milkshake-img" href="https://www.youtube.com/watch?v=a5d9BrLN5K4" target="_blank">
